...
# Loading input configs
dimension = int(config['dim_dense_layer'])
...
# save the classifier
model.save_weights(os.environ['SHARED_OUTPUT_DIR']+"/model.h5")
print("Saved model to disk")

with open(os.environ['SHARED_OUTPUT_DIR']+'/stats.json', 'wb') as f:
